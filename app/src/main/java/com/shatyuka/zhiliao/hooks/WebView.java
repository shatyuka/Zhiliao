...
public class WebView implements IHook {
    ...
    static final String script_hide_subscribe = "var subscribe=document.getElementsByClassName('Toolbar-functionButtons')[0].lastChild;for(var i=0;i<subscribe.children.length;i++){if(subscribe.children[i].classList.contains('Avatar')){var styleSubscribe=document.createElement('style');styleSubscribe.innerHTML='.'+subscribe.className+'{display:none!important}';document.body.append(styleSubscribe);break}};";
